...
The New App can be found on https://www.github.com/narbehouse](https://github.com/NARBEHOUSE/Benny-s-Accessibility-Hub-2.0)
...
### Predictive Text Keyboard (`new keyboard/`)
